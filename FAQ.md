...
The tool creates its own `📊 │ live stats` category, so it won't touch a
differently-named one. Point it at another name with
`STATS_CATEGORY_NAME="📊 │ my stats"` if you want.
